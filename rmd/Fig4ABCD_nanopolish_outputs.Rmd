...
library(patchwork)
library(here)
here::i_am("rmd/Fig4ABCD_nanopolish_outputs.Rmd")
```


```{r}
read_tsv(here("data/download_zenodo/mRNA_eventalign/YFL031W_mRNA.CRY1_Tm_NoExo.eventalign_output.txt"), col_names = c("contig", "position",	"reference_kmer",	"read_id",	"strand",	"event_index",	"event_level_mean",	"event_stdv",	"event_length",	"model_kmer",	"model_mean",	"model_stdv",	"standardized_level")) %>%
  add_column(genotype = "wild-type") -> wt

read_tsv(here("data/download_zenodo/mRNA_eventalign/YFL031W_mRNA.xrn1tpt1_Tm_NoExo.eventalign_output.txt"), col_names = c("contig", "position",	"reference_kmer",	"read_id",	"strand",	"event_index",	"event_level_mean",	"event_stdv",	"event_length",	"model_kmer",	"model_mean",	"model_stdv",	"standardized_level")) %>%
