...
file_loc = dir_ls(path = here('data/Nanopore_summary_data/'))
...
purrr::map_df(file_loc, read_lookup) %>%
  ...
  separate(enzyme, into = c("enzyme"), extra = "drop") -> allreads
...
# ISSUE: subsetting seq summaries for size is breaking things, see https://github.com/hesselberthlab/RNARePore/issues/4
```
