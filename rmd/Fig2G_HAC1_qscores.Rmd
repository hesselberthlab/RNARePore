...
mutant <- read_delim(here("data/pileup_scores/mt.numeric.pileup"), delim = "\t", col_types = cols(.default = "c" ), col_names = c("chrom", "pos", "ref", "depth", "align", "base_qual", "align_qual", "numeric_base_qual"))
control <- read_delim(here("data/pileup_scores/wt.numeric.pileup"), delim = "\t", col_types = cols(.default = "c" ), col_names = c("chrom", "pos", "ref", "depth", "align", "base_qual", "align_qual", "numeric_base_qual"))
```
